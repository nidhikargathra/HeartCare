...
def getAccuracy(trainingSet,testSet):
	...
	print "Fixed vvvalue Error:"+str(tots1-float(correct1))
	print "percent error:"+str(((tots1-float(correct1))/100)*100)
...
def main():
	...
	loadDataset('compareOriginal.txt','compare.txt', trainingSet, testSet)
